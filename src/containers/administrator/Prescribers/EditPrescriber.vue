        ...
        <v-layout row wrap class="my-scroll-enabled-1">
          <v-card-text class="pb-0">
            ...
            <v-layout row wrap>
              ...
              <v-flex xs3 class="px-3 py-0">
                <v-text-field label="Phone" v-model="info.phone_num"  :rules="[rules.phone]" hint="xxx-xxx-xxxx" persistent-hint required></v-text-field>
              </v-flex>
              <v-flex xs3 class="px-3 py-0">
              ...
              <v-flex xs3 class="px-3 py-0">
                <v-text-field label="Email" v-model="info.email_addr_txt" :rules="[rules.email]" required></v-text-field>
              </v-flex>
