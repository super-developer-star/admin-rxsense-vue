            ...
            <v-flex xs12 class="px-0">
              ...
              <v-card-text>
                <v-text-field label="User Id*" v-model="user_info.uid" :rules="[rules.required]"
                              :disabled="type !== 'new'"></v-text-field>
        ...
        <v-flex xs6>
          <v-layout row wrap>
            <v-flex xs12 class="px-2">
              ...
              <v-divider></v-divider>
              <v-card-text>
                <v-text-field label="First Name*" v-model="user_info.fname" :rules="[rules.required]"></v-text-field>
                <v-text-field label="Last Name*" v-model="user_info.lname" :rules="[rules.required]"></v-text-field>
                <v-layout row wrap>
                  <v-flex xs5>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          password: (value) => {
            if (!!value) {
              return (value === this.user_info.pwd) || 'conform password'
            } else {
              return 'Required'
            }
          },
