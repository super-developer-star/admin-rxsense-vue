    ...
    data() {
      return {
        ...
        rules: {
          ...
          p1Rules: (v) => ((!v && !this.info.quantity1) || (!!v && !!this.info.quantity1)) || 'If Qty1 exist, Price1 Required too',
          p2Rules: (v) => ((!v && !this.info.quantity2) || (!!v && !!this.info.quantity2)) || 'If Qty2 exist, Price2 Required too',
          p3Rules: (v) => ((!v && !this.info.quantity3) || (!!v && !!this.info.quantity3)) || 'If Qty3 exist, Price3 Required too',
          q1Rules: (v) => ((!v && !this.info.price_amt1) || (!!v && !!this.info.price_amt1)) || 'If Price1 exist, Qty1 Required too',
          q2Rules: (v) => ((!v && !this.info.price_amt2) || (!!v && !!this.info.price_amt2)) || 'If Price2 exist, Qty2 Required too',
          q3Rules: (v) => ((!v && !this.info.price_amt3) || (!!v && !!this.info.price_amt3)) || 'If Price3 exist, Qty3 Required too',
          q11Rules: (v) => (
