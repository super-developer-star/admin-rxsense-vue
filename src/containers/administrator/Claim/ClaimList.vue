                ...
                <v-layout row wrap class="pl-4">
                  <v-flex xs3>
                    <v-card-text>
                      ...
                      <p><span>Claim Date:</span> {{ convertDate(props.item['ClaimDate']) }}</p>
                      ...
                      <p><span>Claim Type Code:</span> {{ convertTypeCode(props.item["ClaimTypeCode"]) }}</p>
                  ...
                  <v-flex xs3>
                    <v-card-text>
                      ...
                      <p><span>Product Type:</span> {{ props.item['ProductType'] }}</p>
                      <p><span>Member Copay Amt:</span> {{ props.item['CopayAmount'] }}</p>
                    </v-card-text>
                  </v-flex>
                  <v-flex xs3>
                    <v-card-text>
                      <p><span>PricingSource:</span> {{ props.item['PricingSource'] }}</p>
                      <p><span>Deductible Amt:</span> {{ props.item['AmountAppliedToPeriodicDeductible'] }}</p>
                      <p><span>Member Paid Amt:</span> {{ props.item['PatientPayAmount'] }}</p>
                      <p><span>Pricing Source Desc:</span> {{ props.item['PricingSourceDescription'] }}</p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setItems() {
        const {fullData} = this, that = this
        this.items = fullData.map(item => (
          {
            ...item,
