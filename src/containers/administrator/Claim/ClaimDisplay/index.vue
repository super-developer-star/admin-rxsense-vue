                ...
                <v-card-text>
                  <v-layout row wrap>
                    <v-flex xs4 class="text-xs-center">
                      <span>Name: <a :href="'/administration/member/edit/' + claim['Member Id']"><b>{{claim['First Name']}} {{claim['Last Name']}}</b></a></span>
                    </v-flex>
                    <v-flex xs4 class="text-xs-center">
                      <span>Member Id: <a :href="'/administration/member/edit/' + claim['Member Id']"><b>{{claim['Member Id']}}</b></a></span>
                    </v-flex>
                    <v-flex xs4 class="text-xs-center">
      ...
      getClaimData(selectedClaim) {
        ...
        services.getByIdClaim(data).then(function (res) {
          ...
          const newClaim = Object.assign({}, {...claim}, {
            "Provider Claim Amt": that.convertToDollar(claim['Provider Claim Amt'] || '0'),
            'Store Dispense Fee Amt': that.convertToDollar(claim['Store Dispense Fee Amt'] || '0'),
            'Gross Amt Due Submit': that.convertToDollar(claim['Gross Amt Due Submit'] || '0'),
            'Other Payor Submit Amt': that.convertToDollar(claim['Other Payor Submit Amt'] || '0'),
            'Store Ingred Cost Amt': that.convertToDollar(claim['Store Ingred Cost Amt'] || '0'),
            'Sales Tax Amt': that.convertToDollar(claim['Sales Tax Amt'] || '0'),
            'Dispense Fee Submit Amt': that.convertToDollar(claim['Dispense Fee Submit Amt'] || '0'),
            'Store Admin Fee Amt': that.convertToDollar(claim['Store Admin Fee Amt'] || '0'),
            'Store Claim Amt': that.convertToDollar(claim['Store Claim Amt'] || '0'),
            'Member Paid Amt': that.convertToDollar(claim['Member Paid Amt'] || '0'),
            'Member Copay Amt': that.convertToDollar(claim['Member Copay Amt'] || '0'),
            'Deductible Amt': that.convertToDollar(claim['Deductible Amt'] || '0'),
            'Store Unit Price Amt': that.convertToDollar(claim['Store Unit Price Amt'] || '0'),
            'Store Price Disc Pct': that.convertToPercent(claim['Store Price Disc Pct'] || '0'),
            'Plan Dispense Fee Amt': that.convertToDollar(claim['Plan Dispense Fee Amt'] || '0'),
            'Plan Ingred Cost Amt': that.convertToDollar(claim['Plan Ingred Cost Amt'] || '0'),
            'Plan Claim Amt': that.convertToDollar(claim['Plan Claim Amt'] || '0'),
            'Plan Admin Fee Amt': that.convertToDollar(claim['Plan Admin Fee Amt'] || '0'),
            'Plan Price Disc Pct': that.convertToPercent(claim['Plan Price Disc Pct'] || '0'),
            'Plan Unit Price Amt': that.convertToDollar(claim['Plan Unit Price Amt'] || '0'),
            'Authorization Required Amt': that.convertToDollar(claim['Authorization Required Amt'] || '0'),
            'Agent Commission Amt': that.convertToDollar(claim['Agent Commission Amt'] || '0'),
            'Allow Refill Pct': that.convertToPercent(claim['Allow Refill Pct'] || '0'),
