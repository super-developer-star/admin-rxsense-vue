...
const providerServices = {
  ...
  getNCSZProviderList: function (data) {
    const dataUrl = '/static/api/get_provider_list_using_ncsz.json'
    const apiUrl = 'webservices.asmx/get_provider_list_using_ncsz'
    return getJSONData(dataUrl, apiUrl, data)
  },

  getStoreProviderList: function (data) {
    const dataUrl = '/static/api/get_provider_list_using_store_id.json'
    const apiUrl = 'webservices.asmx/get_provider_list_using_store_id'
    return getJSONData(dataUrl, apiUrl, data)
  },

  getNABPProviderList: function (data) {
    const dataUrl = '/static/api/get_provider_list_using_id.json'
    const apiUrl = 'webservices.asmx/get_provider_list_using_id'
    return getJSONData(dataUrl, apiUrl, data)
  },
  ...
  UpdateMppList: function (info, user) {
    const dataUrl = '/static/api/return.json'
  ...
  getPricingList: function (info, pcc) {
